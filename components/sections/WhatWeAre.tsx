...
function TiltCard({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div
      ref={ref}
      className="group relative rounded-2xl border border-base-800/20 overflow-hidden bg-base-100/40 [transform-style:preserve-3d] will-change-transform transition-transform h-full flex flex-col box-border min-h-[256px]"
      onMouseMove={(e) => {
